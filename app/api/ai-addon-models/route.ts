...
/** GET /api/ai-addon-models — proxy to TPC-AI backend */
export async function GET(request: Request) {
  try {
    const base = await getBackendUrl();
    const upstream = await fetch(`${base}/api/admin/ai-addon-models`, {
      headers: {
...
/** PUT /api/ai-addon-models — proxy to TPC-AI backend */
